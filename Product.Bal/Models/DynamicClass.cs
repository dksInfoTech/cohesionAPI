...
/// <summary>
/// Generate a new type that uses System.Object as the base class
/// </summary>
public class DynamicClass : DynamicClass<object>
{
    public DynamicClass(Dictionary<string, Type> properties) : base(properties)
    {
    }
}
...
public class DynamicClass<T> where T : class
{
    private readonly Dictionary<string, MethodInfo> _setMethods;

    public DynamicClass(Dictionary<string, Type> properties)
    {
    ...
    {
        var newTypeName = "Product.Web.Models.Rule.TriggerModel";
    ...
    public void SetValue(T instance, string propertyName, object propertyValue)
    {
        ...
        var tProp = instance.GetType().GetProperty(propertyName).PropertyType;
        setter.Invoke(instance, new[] { Convert.ChangeType(propertyValue, tProp) });
    }
